...
let numberType = 0;
let numType = numberType > 0 ? "positive" :  numberType < 0 ? "negative" : "zero" ;
console.log(numType);
...
let divisible = 88;
let visibleBoard = divisible % 5 === 0 && divisible % 11 === 0 ? '"Divisible"' : '"Not Divisible"' ;
...
let ageForVoting = 18;
let votingTime = ageForVoting >=18  ? '"Eligible for voting"' : '"Not Eligible for voting" ' ;
...
let balance = 8800;
let bankBalance = balance > 1000 ? '"Transaction Successful"' : '"Insufficient Balance"' ;
...
let namePerson = "Alif"
let Personboard = namePerson.startsWith('A') ? '"Starts with A"': '" Does not starts with A"' ;
